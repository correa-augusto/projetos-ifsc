            ...
            <tbody>
                <?php $__currentLoopData = $produtos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="<?php echo e(route("produto.show", $produto->id)); ?>">Motrar</a>
                            <a class="btn btn-secondary" href="<?php echo e(route("produto.edit", $produto->id)); ?>">Editar</a>
                            <a href="#" class="btn btn-danger btn-remover" data-bs-toggle="modal" data-bs-target="#id-remove-modal" value="<?php echo e(route("produto.destroy", $produto->id)); ?>">Remover</a>
                        </td>
                    </tr>
...
</html><?php /**PATH C:\Users\Aluno\Documents\ProjetoAula2\resources\views/Produto/index.blade.php ENDPATH**/ ?>