        ...
        <form method="POST" action="<?php echo e(route("tipoproduto.update", $tipoProduto->id)); ?>">
          ...
          <input name="_method" type="hidden" value="PUT">
            ...
            <div class="mb-3">
              ...
              <input name="descricao" type="text" class="form-control" id="id-descricao" value="<?php echo e($tipoProduto->descricao); ?>" placeholder="Digite a descrição do tipo de produto">
            </div>
...
</html><?php /**PATH C:\Users\Aluno\Documents\ProjetoAula2\resources\views/TipoProduto/edit.blade.php ENDPATH**/ ?>