            ...
            <tbody>
                @foreach ($produtos as $produto)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="{{route("produto.show", $produto->id)}}">Motrar</a>
                            <a class="btn btn-secondary" href="{{route("produto.edit", $produto->id)}}">Editar</a>
                            <a href="#" class="btn btn-danger btn-remover" data-bs-toggle="modal" data-bs-target="#id-remove-modal" value="{{route("produto.destroy", $produto->id)}}">Remover</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
